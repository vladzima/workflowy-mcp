...
@mcp.tool(
    ...
    description="Retrieve a specific WorkFlowy node by ID"
)
...
@mcp.tool(
    ...
    description="List WorkFlowy nodes with optional filtering"
)
...
@mcp.tool(
    ...
    description="Delete a WorkFlowy node and all its children"
)
...
@mcp.tool(
    ...
    description="Mark a WorkFlowy node as completed"
)
...
@mcp.tool(
    ...
    description="Mark a WorkFlowy node as not completed"
)
...
@mcp.tool(
    ...
    description="Search for WorkFlowy nodes by text content"
)
